      ...
      <main className="flex-1 py-8 md:py-12 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 md:mb-12">
            <div className="luxury-card p-6 text-center">
              ...
              {stats.skillsLearning === 0 && (
                <Button variant="link" className="!text-yellow-400 font-bold mt-2" asChild>
            ...
            <div className="luxury-card p-6 text-center">
              ...
              {stats.skillsTeaching === 0 && (
                <Button variant="link" className="text-purple-400 font-bold mt-2" asChild>
            ...
            <div className="luxury-card p-6 text-center">
              ...
              <Button variant="link" className="!text-green-400 font-bold mt-2" asChild>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 md:mb-12">
            ...
            <div className="luxury-card p-6">
              <h3 className="text-2xl font-lora font-semibold text-white mb-4">Quick Actions</h3>
